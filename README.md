...
│    └─ModuleList: 2-7                                                           --                        --
│    │    └─MBAG: 3-6                                                            [1, 65536, 48]            772,920
│    │    └─MBAG: 3-7                                                            [1, 65536, 48]            772,920
│    │    └─MBAG: 3-8                                                            [1, 65536, 48]            772,920
...
├─Image_Reconstruction: 1-4                                                      [1, 4, 256, 256]          --
│    └─Sequential: 2-14                                                          [1, 64, 256, 256]         --
│    │    └─Conv2d: 3-9                                                          [1, 64, 256, 256]         27,712
│    │    └─LeakyReLU: 3-10                                                      [1, 64, 256, 256]         --
│    └─Upsample: 2-15                                                            [1, 64, 256, 256]         --
│    └─Conv2d: 2-16                                                              [1, 4, 256, 256]          2,308
==================================================================================================================================
Total params: 2,580,044
Trainable params: 2,580,044
Non-trainable params: 0
Total mult-adds (G): 20.34
==================================================================================================================================
Input size (MB): 0.33
Forward/backward pass size (MB): 21447.06
Params size (MB): 8.22
Estimated Total Size (MB): 21455.61
==================================================================================================================================
